...
syntax keyword javascriptUIRouter containedin=ALLBUT,jsComment,jsLineComment,jsRegexpString,jsString $stateProvider nextgroup=javascriptASstateProviderdot
...
syntax keyword javascriptUIRouter containedin=ALLBUT,jsComment,jsLineComment,jsRegexpString,jsString $urlRouterProvider nextgroup=javascriptASurlRouterProviderdot
...
syntax keyword javascriptUIRouter containedin=ALLBUT,jsComment,jsLineComment,jsRegexpString,jsString $state nextgroup=javascriptASstatedot
...
syntax keyword javascriptUIRouter containedin=ALLBUT,jsComment,jsLineComment,jsRegexpString,jsString $urlRouter nextgroup=javascriptASurlRouterdot
...
syntax keyword javascriptUIRouter containedin=ALLBUT,jsComment,jsLineComment,jsRegexpString,jsString $stateParams $uiViewScroll
