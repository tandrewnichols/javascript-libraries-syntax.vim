...
syntax keyword javascriptjQuery jQuery $ containedin=ALLBUT,jsComment,jsLineComment,jsRegexpString,jsString,jsTemplate,jsTemplateSubstitution nextgroup=@jsAfterIdentifier
