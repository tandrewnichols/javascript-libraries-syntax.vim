...
syntax match   jsJdot            contained /\./ nextgroup=javascriptJMethods
...
syntax keyword javascriptJGlobalMethod   describe done runs waitsFor it beforeEach afterEach beforeAll afterAll containedin=ALLBUT,jsComment,jsLineComment,jsRegexpString,jsString nextgroup=@jsAfterIdentifier

syntax keyword javascriptJGlobalMethod   xdescribe xit containedin=ALLBUT,jsComment,jsLineComment,jsRegexpString,jsString nextgroup=@jsAfterIdentifier

syntax keyword javascriptJGlobalMethod   spyOn containedin=ALLBUT,jsComment,jsLineComment,jsRegexpString,jsString nextgroup=@jsAfterIdentifier
...
syntax keyword javascriptJGlobalMethod   expect fail pending containedin=ALLBUT,jsComment,jsLineComment,jsRegexpString,jsString nextgroup=@jsAfterIdentifier
